...
<template>
    <Transition name="slide">
        <div class="leftbar"  v-if="isActive">
            ...
            <div>
                <ul class="link-list">
                    <li v-for="link in links" :key="link.name">
                        <a class="link" :href="link.path">{{link.name}}</a>
                    </li>
                </ul>
            </div>
        </div>
...
/* Define the enter-active-class for the slide-in animation *//* Define the enter-from state for the slide-in animation */
.slide-enter-from {
    transform: translateX(-100%);
}

/* Define the enter-active class for the sliding-in animation */
.slide-enter-active {
    transition: transform 0.2s ease-out;
}

/* Define the enter-to state for the slide-in animation */
.slide-enter-to {
    transform: translateX(0);
}

/* Define the leave-from state for the slide-out animation */
.slide-leave-from {
    transform: translateX(0);
}

/* Define the leave-active class for the sliding-out animation */
.slide-leave-active {
    transition: transform 0.2s ease-out;
}

/* Define the leave-to state for the slide-out animation */
.slide-leave-to {
    transform: translateX(-100%);
}
/* media query for bigger then 425px */
